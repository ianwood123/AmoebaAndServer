...
public:
    ...
    bool checkBeginStream(string& data, Connection& connection)
    {
    ...
    bool checkEndStream(string& data)
    {
...
private:
    ...
    string filterDataStream(string& dataStream)
    {
    ...
    string prepareDataStream(string& dataStream)
    {
        return beginStreamTag + dataStream + endStreamTag;
    }

    string escapeCharacters(string key)
    {
        string result = "";
